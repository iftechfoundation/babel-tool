...
static struct l9rec l9_registry[] = {
    ...
    { 0x5323, 0x11, "LEVEL9-003" },
    { 0x6972, 0x55, "LEVEL9-003" },
    ...
    { 0x6155, 0xe8, "LEVEL9-005" },
    { 0x616a, 0x90, "LEVEL9-005" },
    ...
    { 0xb92d, 0x00, "LEVEL9-011-1" },
    { 0xb92d, 0x25, "LEVEL9-011-1" },
    ...
    { 0x7334, 0x87, "LEVEL9-014" },
    { 0xb8b5, 0x27, "LEVEL9-014" },
